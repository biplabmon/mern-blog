                    ...
                    <>
                        ...
                        </div>
                        {
                            comments.map(comment => (
                                <Comment key={comment._id} comment={comment} onLike={handelLike} onEdit={handelEdit} onDelete={(commentId) => {
                                    setShowModal(true)
                ...
                <Modal.Body>
                    <div className="text-center">
                        ...
                        <div className="flex justify-center gap-4">
                            <Button color='failure' onClick={() => handelDelete(commentToDelete)}>
                                Yes, I'm sure
                            </Button>
